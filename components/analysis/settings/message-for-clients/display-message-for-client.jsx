...
export default function DisplayMessageForClientDialog() {
        ...
        <DialogHeader>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-gray-200 p-4 rounded space-y-4'>
              ...
              <div className='flex items-center justify-between'>
                <p>بند القسم</p>
                <span className='block text-sm bg-blue-500/20 text-blue-500 p-2 rounded-md'> رقم الصك</span>
              </div>
              <div className='flex items-center justify-between'>
                <p>الرسالة التوضيحية</p>
                <p>رقم الصك يقصد به الرقم الموجود في وثيقة التملك</p>
              </div>
