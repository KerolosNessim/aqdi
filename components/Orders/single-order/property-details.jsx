...
export default function PropertyDetails({ data }) {
  ...
  const nationalAddress = [
    { label: "المدينة", value: data?.step1?.city_name || data?.step1?.property_city_id || "---", icon: <Copy size={14} />, borderColor: "border-blue-500" },
    {
      label: "المنطقة", value: data?.step1?.property_place_name || data?.step1?.property_place_id || "---", icon: <Copy size={14} />, borderColor: "border-pink-500" },
