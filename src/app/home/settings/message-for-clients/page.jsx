...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen p-6">
      <Header page='welcome' title={"الإعـدادات"} isMain={false} first="الرئيــسية" firstURL="/" second='الإعـدادات' secondURL="/home/settings" third="رســائل توضيحية للعمــلاء" thirdURL="/home/settings/message-for-clients" />
